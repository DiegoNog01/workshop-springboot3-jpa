...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas ante", 20190.0, "");
		Product p3 = new Product(null, "Macbook Pro", "Nam eleifend maxumus tortor, at mollis.", 1250.0, "");
